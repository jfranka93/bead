...
passport.use('local-signup', new LocalStrategy({
    ...
    function(req, loginname, password, done) {
        req.app.models.user.findOne({ loginname: loginname }, function(err, user) {
            if (err) { return done(err); }
            if (user) {
                return done(null, false, { message: 'Létező bejelentkező név.' });
            }
...
orm.loadCollection(require('./models/nevjegy'));
